...
//   const { notifCount, setOpen, open } = props;
  ...
  const navigateToHome = () => {
    navigate('/'); // navigating to default route
  };
  //
      ...
      <nav className="navbar fixed-top navbar-expand-sm  profile-navbar-guest">
        <div className="container-fluid">
          ...
          <Button variant="link" onClick={navigateToHome}
            ...
            {/* Using a button with an onClick event handler */}
            <Button variant="secondary" onClick={handleButtonClick}
            style={{borderRadius:"20px", borderColor:"rgb(226,11,60)",
            backgroundColor:"rgb(226,11,60)"}}>
              Find Your Next Job
            </Button>
