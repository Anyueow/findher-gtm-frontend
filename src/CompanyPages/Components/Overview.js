    ...
    <Row className="ms-0 me-1 px-2 ">
      <Col md={12} className="">
        <Row className="d-flex justify-content-between align-items-center infoBox-row" style={{width:"101%"}}>
          ...
          <Col  xs={11} md={6} className="infoBoxTwo mx-0">
            <div className="rectBox">
              <Row className="d-flex justify-content-center align-items-center">
                ...
                <Col
                  ...
                  md="5"
                  lg="2"
                  className="Rect ms-2 p-0 text-center"
                  style={{ alignItems: "center"}}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
        ...
        >
          ...
          <Col>
            <Row className="d-flex justify-content-between mt-2 company-page-flexibility-row">
              ...
              >
                  <Col className="d-flex align-items-center company-page-flexibility-header ps-5 pe-0">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="22"
                      height="22"
            ...
            <Row className="d-flex justify-content-between mt-2 company-page-flexibility-row">
              ...
              >
                  <Col className="d-flex align-items-center company-page-flexibility-header  ps-5 pe-0">
                    ...
                    <h2 className="ms-3 me-0 my-0">Passion for Technology</h2>
                  </Col>
                  <Col>
            ...
            <Row className="d-flex justify-content-between mt-2 company-page-flexibility-row">
              ...
              >
                  <Col className="d-flex align-items-center company-page-flexibility-header ps-5 pe-0">
                    ...
                    <h2 className="ms-3 me-0 my-0">Approachable Leadership</h2>
                  </Col>
                  <Col>
                    <p className="pt-2 px-1">
                      We offer flexible work arrangements, including options..
